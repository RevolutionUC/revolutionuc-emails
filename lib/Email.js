  ...
  build(outputType, templateName, templateData) {
    return new Promise((resolve, reject) => {
      ...
      this.getTemplate(templateName)
        ...
        .then(data => {
          if (outputType === 'text') {
            // convert the html to text and resolve
            resolve(htmlToText.fromString(data, { wordWrap: 100, uppercaseHeadings: false }))
          }
          return data // continue with html build
        })
